...
> **Cooking analogy:** Think of learning Python like learning to cook. At first
> the kitchen looks overwhelming — knives, pots, and measuring cups everywhere.
> But once you know the basics, you can follow any recipe and eventually invent
> your own dishes. These notes assume **no prior Python experience**. Each module
...
> **Cooking analogy:** Think of Python as your **kitchen**. Raw data is your
> raw ingredient — unprocessed and not yet useful on its own. Python gives you
> all the tools (knives, pots, measuring cups) to transform that raw ingredient
> into a finished dish: a clean dataset, a chart, or a trained prediction model.
> Just as every chef begins by mastering basic knife skills before cooking a full
> meal, we start here with Python fundamentals before building machine learning
> models.
...
- Declare variables and identify Python data types (str, int, float, bool).
- Perform arithmetic operations and format output using f-strings.
- Write conditional logic using `if`, `elif`, and `else` statements.
- Apply comparison and logical operators to business decision problems.
:::

### Variables and Data Types

> **Cooking analogy:** A **variable** is a **labelled kitchen container**. Just
> as you keep flour in a jar marked *"Flour"* and olive oil in a bottle marked
> *"Oil"*, Python stores values in named variables. Open any container to check
> what is inside, update the contents, or hand it to another part of the recipe.
...
> **Cooking analogy:** An f-string is like reading a recipe aloud: *"Add
> {sugar} grams of sugar."* Python fills in the placeholder with the actual
> value stored in that container — so you always see the real quantity, not
> just the label.
>
...
> **Cooking analogy:** A conditional statement is the chef **checking the dish
> mid-cook**: *"If the sauce is too thick, add water. Else if it needs more
> flavour, add salt. Otherwise, serve as-is."* The kitchen adapts to the current
> state of the ingredients — and so does your code.
...
- Create histograms and density curves to explore variable distributions.
- Use box plots to compare groups and identify outliers.
- Build scatter plots to reveal relationships between two variables.
- Construct bar charts to compare categorical aggregates.
:::

> **Cooking analogy:** Before serving a dish you **taste it and check the
> presentation** — you look at the colour, texture, and balance before it reaches
> the guest. Visualisation is your **taste-test for data**: it lets you spot what
> looks off, what looks great, and what needs adjustment before you commit to
> modelling. **Matplotlib** gives you full manual control (cooking entirely from
> scratch), while **Seaborn** provides beautifully pre-set templates (using a
> quality spice blend that does most of the work for you).
...
[Jupyter Notebooks](https://github.com/thugmba/MLBA)